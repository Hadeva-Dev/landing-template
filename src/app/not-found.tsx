      ...
      <div className="max-w-2xl mx-auto text-center">
        ...
        >
          ...
          <div className="bg-white/60 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-white/20 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
            ...
            <Link href="/privacy" className="text-violet-600 hover:text-violet-700 font-medium text-sm">
              View Privacy →
            </Link>
          </div>
          ...
          <div className="bg-white/60 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-white/20 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
            ...
            <Link href="/#waitlist" className="text-fuchsia-600 hover:text-fuchsia-700 font-medium text-sm">
              Join Waitlist →
            </Link>
          </div>
        </motion.div>
